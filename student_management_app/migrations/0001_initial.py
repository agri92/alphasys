    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('costo_ins', models.DecimalField(decimal_places=2, max_digits=7)),
                ('costo_mat', models.DecimalField(decimal_places=2, max_digits=7)),
                ('costo_mes', models.DecimalField(decimal_places=2, max_digits=7)),
                ('descuento_pp', models.DecimalField(decimal_places=2, max_digits=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(1, 'Activo'), (2, 'Inactivo'), (3, 'Baja')], default=1, max_length=150)),
                ...
                ('status_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='student_management_app.studentstatus')),
            ],
        ),
        migrations.CreateModel(
            name='StudentResult',
